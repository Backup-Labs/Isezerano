...
export default function HomepageBuilder() {
  ...
  useEffect(() => { if (token) fetchLayout(); }, [token]);
    ...
    <div className="flex flex-col gap-6 text-theme-black animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-theme-gray-100">
        ...
        <button
          ...
          disabled={saving}
          className="flex items-center gap-1.5 px-4 py-2.5 bg-theme-blue hover:bg-theme-blue-glow text-white text-xs font-mono font-bold uppercase tracking-wider transition-all self-start sm:self-center cursor-pointer disabled:opacity-60"
        >
      ...
      {/* Success banner */}
      {success && (
        <div className="p-4 border border-green-600 text-green-700 text-xs font-mono flex items-center gap-2 bg-green-50">
      ...
      <div className="flex flex-col gap-3 max-w-4xl w-full">
        {layout.map((block, idx) => (
          <div
            key={block.id}
            className={`p-5 border flex items-center justify-between gap-6 transition-all bg-white ${
              block.is_visible
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-0.5">
                <h3 className="serif-title text-base font-bold text-theme-black uppercase">
                  {getSectionLabel(block.section_type)}
                </h3>
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                ...
                disabled={idx === 0}
                className="p-1.5 border border-theme-gray-100 hover:bg-theme-light-gray hover:border-theme-blue disabled:opacity-30 disabled:cursor-not-allowed transition-all cursor-pointer text-theme-black"
              >
              ...
              <button
                ...
                className={`p-1.5 border transition-all cursor-pointer ${
                  block.is_visible
                    ...
                    : 'border-theme-gray-100 text-theme-gray-400 hover:bg-theme-light-gray hover:border-theme-blue'
                }`}
        ...
        {layout.length === 0 && (
          <div className="text-center py-16 text-xs font-mono uppercase tracking-wider text-theme-gray-400 border border-theme-gray-100 bg-white">
